  ...
  const runFaceRecognition = useCallback(async () => {
    ...
    try {
      ...
      await OfflineDatabase.saveRecord({
        ...
        vectorId: matched ? bestUserId : 'UNKNOWN',
      });
      ...
      navigation.replace('Result', {
        ...
        confidence,
        timestamp,
        userId: matched ? bestUserId : 'UNKNOWN',
      });
    } catch (error) {
...
const styles = StyleSheet.create({
  ...
  appTitle: { fontSize: 20, fontWeight: '900', color: '#1C1C1E', letterSpacing: 3 },
  appSubtitle: {
  ...
  faceGuideSuccess: {
    borderColor: '#34C759', borderStyle: 'solid', borderWidth: 3,
  },
  faceGuideError: { borderColor: '#FF3B30' },
  ...
  challengeText: { color: '#1C1C1E', fontSize: 18, fontWeight: '800', letterSpacing: 2 },
  countdownText: { color: '#FF9500', fontSize: 16, fontWeight: '700' },
  ...
  stepLine: { width: 32, height: 2, backgroundColor: 'rgba(0,0,0,0.1)' },
  ...
  statusTitle: { color: '#1C1C1E', fontSize: 15, fontWeight: '700' },
  statusSub: {
  ...
  probText: { color: 'rgba(0,0,0,0.5)', fontSize: 11, fontFamily: 'monospace' },
  probNormal: { color: 'rgba(0,0,0,0.7)' },
  probAlert: { color: '#34C759', fontWeight: '700' },
  spinner: { marginTop: 8 },
